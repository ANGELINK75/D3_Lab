...
var arc = d3.arc().outerRadius(radius - 30).innerRadius(radius - 60);

// TODO: create the pie layout generator.
var pie = d3.pie().value((d) => { return d.count; }).sort(null);
...
d3.tsv("data/donut2.tsv").then((data) => {
    ...
    var regionsByFruit = d3.nest().key((d) => { return d.fruit; }).entries(data);
